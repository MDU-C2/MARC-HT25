...
Measured distance between camera base, x-y plane, and robot base, absolute value.(mm)\\
\hline
...
The estimated angle of the cameras position to the robot base, e.g. 150 degrees, left of robot. (degrees)\\
\hline
