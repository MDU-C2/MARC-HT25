...
!    ***********************************************************
    ...
    PROC main()
        ...
        CONST speeddata movement_speed := v400; ! Movement speed for robot movement
...
!                ConfJ\Off;
            ...
            CASE 9:
                ...
                MoveJ Offs(current_target,0,0,0),movement_speed,fine,tGripper;
!                moveToHomeTarget;
                MoveJ Offs(shared_movement_vars.target,0,0,0),movement_speed,fine,tGripper;
                MoveJ shared_movement_vars.target,movement_speed,fine,tGripper;
                
!                MovementProc Offs(current_target,0,0,20), step_size, max_magnitude, movement_speed;
!                MovementProc Offs(shared_movement_vars.target,0,0,20), step_size, max_magnitude, movement_speed;
!                MovementProc shared_movement_vars.target, step_size, max_magnitude, movement_speed;
                ConfJ\Off;
                ConfL\Off;
            ENDTEST
