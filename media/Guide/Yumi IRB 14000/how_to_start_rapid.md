# How to start RAPID code through RobotStudio
...
The same procedure is done for the left and right arm tasks but **Movement_left** and **Movement_right** is loaded to each respectively.