    ...
    PROC main()
        ...
        WHILE TRUE DO
            ...
            CASE flag_move_calibration:
                ...
                MoveJ shared_movement_left.target,movement_speed_calibration,fine,tGripper;
            ...
            CASE flag_presentation_fetch:
                PresentationFetchMug shared_movement_left.mug.position,pick_offset,shared_movement_left.mug.normal; 
